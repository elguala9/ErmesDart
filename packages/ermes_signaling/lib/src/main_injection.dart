...
mixin MainInjectionErmesSignalingMixin { // GENERATED CODE - DO NOT MODIFY BY HAND
  ...
  void beforeRegisterAllSingletonsErmesSignaling({String key = 'default'}) {} // GENERATED CODE - DO NOT MODIFY BY HAND

  /// Connects every discovered singleton under [key]. // GENERATED CODE - DO NOT MODIFY BY HAND
  void registerAllSingletonsErmesSignaling({String key = 'default'}) { // GENERATED CODE - DO NOT MODIFY BY HAND
    beforeRegisterAllSingletonsErmesSignaling(key: key); // GENERATED CODE - DO NOT MODIFY BY HAND
    RegistryManager.instance // GENERATED CODE - DO NOT MODIFY BY HAND
      ..connectInstance<IErmesBookRepository, ErmesBookRepository>(() => ErmesBookRepository.dependencyInjectionFactory(key: key), key: key) // GENERATED CODE - DO NOT MODIFY BY HAND
      ..connectInstance<IErmesBookService, ErmesBookServiceBase>(() => ErmesBookServiceBase.dependencyInjectionFactory(key: key), key: key) // GENERATED CODE - DO NOT MODIFY BY HAND
      ..connectInstance<IErmesSignalingHandler, ErmesSignalingHandler>(() => ErmesSignalingHandler.dependencyInjectionFactory(key: key), key: key) // GENERATED CODE - DO NOT MODIFY BY HAND
      ..connectInstance<IErmesSignalingRepository, ErmesSignalingRepository>(() => ErmesSignalingRepository.dependencyInjectionFactory(key: key), key: key) // GENERATED CODE - DO NOT MODIFY BY HAND
      ..connectInstance<IErmesSignalingService, ErmesSignalingService>(() => ErmesSignalingService.dependencyInjectionFactory(key: key), key: key) // GENERATED CODE - DO NOT MODIFY BY HAND
      ..connectInstance<IErmesSignalingServer, ErmesSignalingServer>(() => ErmesSignalingServer.dependencyInjectionFactory(key: key), key: key); // GENERATED CODE - DO NOT MODIFY BY HAND
    afterRegisterAllSingletonsErmesSignaling(key: key); // GENERATED CODE - DO NOT MODIFY BY HAND
  } // GENERATED CODE - DO NOT MODIFY BY HAND
  ...
  void afterRegisterAllSingletonsErmesSignaling({String key = 'default'}) {} // GENERATED CODE - DO NOT MODIFY BY HAND

  /// Called by [registerAllSingletonsErmesSignalingAsync] right before it connects anything.
  /// Override to customize. // GENERATED CODE - DO NOT MODIFY BY HAND
  Future<void> beforeRegisterAllSingletonsErmesSignalingAsync({String key = 'default'}) async {} // GENERATED CODE - DO NOT MODIFY BY HAND
  ...
  Future<void> registerAllSingletonsErmesSignalingAsync({String key = 'default'}) async { // GENERATED CODE - DO NOT MODIFY BY HAND
    await beforeRegisterAllSingletonsErmesSignalingAsync(key: key); // GENERATED CODE - DO NOT MODIFY BY HAND
    registerAllSingletonsErmesSignaling(key: key); // GENERATED CODE - DO NOT MODIFY BY HAND
    await afterRegisterAllSingletonsErmesSignalingAsync(key: key); // GENERATED CODE - DO NOT MODIFY BY HAND
  } // GENERATED CODE - DO NOT MODIFY BY HAND

  /// Called by [registerAllSingletonsErmesSignalingAsync] right after it finishes connecting
  /// everything. Override to customize. // GENERATED CODE - DO NOT MODIFY BY HAND
  Future<void> afterRegisterAllSingletonsErmesSignalingAsync({String key = 'default'}) async {} // GENERATED CODE - DO NOT MODIFY BY HAND
} // GENERATED CODE - DO NOT MODIFY BY HAND
...
class MainInjectionErmesSignaling with MainInjectionErmesSignalingMixin { // GENERATED CODE - DO NOT MODIFY BY HAND
