...
import 'ermes_storage_and_caching_messages_test.dart' as messages;
import 'generic_caching_repository_test.dart' as generic_caching_repo;
import 'generic_caching_service_test.dart' as generic_caching_svc;
...
void testErmesStorage() {
  ...
  edge_cases.main();
  messages.main();
  generic_caching_repo.main();
  generic_caching_svc.main();
  integration.main();
  storage_repo.main();
  storage_svc.main();
}
